...
function Presentation(options) {
  // Save db for later
  // TODO: Move to dirty to get off of compilation step and open up platforms
  this.dbPath = options.db || path.join(process.cwd(), 'cli-presentation.db');

  // TODO: Consider .set mechanism for options
...
Presentation.prototype = {
  ...
  getSlide: function (cb) {

  }
};

// Define a slide information retrieval helper
