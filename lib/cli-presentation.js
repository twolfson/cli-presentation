...
CliPresentation.cli = function () {
  ...
  program
    ...
    .action(runPresentationMethod('goToIndex'));

  program
    .command('first')
    .description('Go back to the beginning')
    .action(runPresentationMethod('goToFirst'));

  program
    .command('last')
    .description('Jump to the final slide')
    .action(runPresentationMethod('goToLast'));

  program
    .command('next')
    .description('Move following by one slide')
    .action(runPresentationMethod('goToNext'));

  program
    .command('previous')
    .description('Move back by one slide')
    .action(runPresentationMethod('goToPrevious'));
  ...
  program
    ...
    .action(runPresentationMethod('status'));
  ...
  program.parse = function (argv) {
    ...
    if (argv.length === 2) {
      return runPresentationMethod('goToCurrent')(argv);
    }
